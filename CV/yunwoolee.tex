...
\begin{rSection}{Research Experience}
	\begin{rSubsection}{\href{https://faculty.washington.edu/fxia/}{LT4CPR, UW}}{Seattle, WA}{Research Assistant, Supervisor: Prof. Fei Xia}{Jun. 2026 -- Present}
		\item Evaluating LLM-generated situation reports (SITREPs) for crisis response through faithfulness, information coverage, and structured content alignment analysis
        \item Developing section-level and bullet-level evaluation pipelines using ROUGE, BERTScore, and bipartite matching to compare system outputs against reference reports
	\end{rSubsection}
%------------------------------------------------
...
\begin{rSection}{PROJECT EXPERIENCE}
    \begin{rSubsection}{Relational Grounding Failures in Zero-Shot English-to-Chinese Dialogue Summarization}{}{LING 573 Project, University of Washington}{Mar. 2026 -- Jun. 2026}
        \item Co-developed a linguistically grounded dialogue-semantic error taxonomy to evaluate source-faithfulness in cross-lingual dialogue summarization
        \item Diagnosed relational hallucinations in small language models through errors in speaker-role attribution, event structure, modality, and discourse outcomes
