...
\address{
    ...
    Email: \href{mailto:yunu919@uw.edu}{yunu919@uw.edu} % Make the email address clickable
} 
...
\begin{rSection}{PERSONAL PROJECT EXPERIENCE}
...
\begin{rSection}{Languages and Technical Skills}
	...
	\begin{tabular}{@{} >{\bfseries}l @{\hspace{6ex}} l @{}}
        ...
        ML/NLP & PyTorch, scikit-learn, NLTK \\
        Tools & Git, Linux/CLI \\
        Typesetting & \LaTeX \\
